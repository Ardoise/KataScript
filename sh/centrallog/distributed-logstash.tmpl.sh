...
PATTERN_FILE=https://raw.github.com/Ardoise/KataScript/master/sh/etc/logstash/shipper2redis
...
CONF_INPUT=https://raw.github.com/Ardoise/KataScript/master/sh/etc/logstash/input/file.json
...
CONF_OUTPUT=https://raw.github.com/Ardoise/KataScript/master/sh/etc/logstash/output/redis.json
