...
PATTERN_FILE=https://raw.github.com/Ardoise/KataScript/master/sh/etc/elasticsearch/elasticsearch.yml
...
# EOF
  ...
  for p in p34; do
    ...
    #python -m pip install --upgrade screen-resolution-extra; # (1.5.2)
    ...
    #python -m pip install --upgrade ubuntu-drivers-common; # (1.5.2)
    ...
    #python -m pip install --upgrade xkit; # (1.5.2)
