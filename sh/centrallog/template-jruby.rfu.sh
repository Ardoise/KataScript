#!/bin/sh -e
### BEGIN INIT INFO
# Provides: centrallog: jruby
# Short-Description: DEPLOY SERVER: [JRUBY]
# Author: created by: https://github.com/Ardoise
# Update: last-update: 20130714
### END INIT INFO

# Description: SERVICE CENTRALLOG: jruby (...)
# - deploy jruby v1.7.4
#
...
#
# CONFIG:   [ "/etc/jruby", "/etc/jruby/test" ]
# BINARIES: [ "/opt/jruby/", "/usr/share/jruby/" ]
# LOG:      [ "/var/log/jruby/" ]
# RUN:      [ "/var/run/jruby/" ]
# INIT:     [ "/etc/init.d/jruby" ]

# @License

DESCRIPTION="JRUBY Server";
NAME="jruby";
