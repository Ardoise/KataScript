#!/bin/sh -e
### BEGIN INIT INFO
# Provides: centrallog: vagrant
# Short-Description: DEPLOY SERVER: [VAGRANT]
# Author: created by: https://github.com/Ardoise
# Update: last-update: 20130714
### END INIT INFO

# Description: SERVICE CENTRALLOG: vagrant (...)
# - deploy vagrant v1.1.13
#
# Requires : you need root privileges tu run this script
# Requires : curl wget make build-essential zlib1g-dev libssl-dev git-core
#
# CONFIG:   [ "/etc/vagrant", "/etc/vagrant/test" ]
# BINARIES: [ "/opt/vagrant/", "/usr/share/vagrant/" ]
# LOG:      [ "/var/log/vagrant/" ]
# RUN:      [ "/var/run/vagrant/" ]
