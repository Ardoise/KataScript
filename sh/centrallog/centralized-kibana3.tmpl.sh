...
# PLUGINS:  [ "/usr/share/kibana3/plugins" ]
# DATA:     [ "/usr/share/kibana3/data" ]
    ...
    for p in p34; do
      ...
      case ${project} in
        p34)
          ...
          #python -m pip install --upgrade screen-resolution-extra; # (3.1.2)
          ...
          #python -m pip install --upgrade ubuntu-drivers-common; # (3.1.2)
          ...
          #python -m pip install --upgrade xkit; # (3.1.2)
