...
# PLUGINS:  [ "/usr/share/centrallog/plugins" ]
# DATA:     [ "/usr/share/centrallog/data" ]
    ...
    for p in p34; do
      ...
      case ${project} in
        p34)
          ...
          #python -m pip install --upgrade screen-resolution-extra; # (1.5.5)
          ...
          #python -m pip install --upgrade ubuntu-drivers-common; # (1.5.5)
          ...
          #python -m pip install --upgrade xkit; # (1.5.5)
